      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://www.pinterest.com/pin/376121006391063822/",
                   'caption'=>'- 𝐖𝐄𝐋𝐂𝐎𝐌𝐄 ⚙
↯Tele↯.                     ↯CH↯\n:-  @C_P_8              :-  @K_8_U',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'أضــافــة حــســاب🖤','callback_data'=>'login']],
                          [['text'=>"المــطــور♻️",'url'=>"https://t.me/K_8_U"]],
                      ]
                  ])
              ]);   
          } 
if($text == '/video'){
              ...
              'caption'=>'طرق السحب',
                      'reply_markup'=>json_encode([
                      'inline_keyboard'=>[                       
                       [['text'=>"للــتــواصــل🤓", 'url'=>"https://t.me/K_8_U"]],
                       ]
                       ])
                       ]);
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"𝙷𝙸 𝙱𝚁𝙾 𝙸𝙽 𝚃𝙷𝙴 𝙲𝙾𝙽𝚃𝚁𝙾𝙻 𝙱𝚈 ~ @K_8_U"
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'بـدء الـصـيـد⏸','callback_data'=>'run'],['text'=>'ايـقـاف الـصـيـد▶️','callback_data'=>'stop']],
                              ...
                              [['text'=>'الـمـطـور☄️','url'=>'t.me/K_8_U'],['text'=>' قـنـاتـى 💣','url'=>'t.me/C_P_8']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
اضغط في الاسفل لمراسله المطور 🌚🤍",
							'reply_markup'=>json_encode([
                  'inline_keyboard'=>[
                      [['text'=>'لـمـراسـلـة الـمـطـور🌐','url'=>'t.me/K_8_U']]
					  [['text'=>"قـنـاة صـيـد الـمـشـتركـيـن🦈", 'url'=>"t.me/C_P_8"]],
                  ]
							])
					]);
				}
            ...
            $bot->editMessageText([
                ...
                'reply_markup'=>json_encode([
                    'inline_keyboard'=>[
                        ...
                        [['text'=>'الـمـطـور🥊','url'=>'t.me/K_8_U'],['text'=>'قـنـاتـى♻️','url'=>'t.me/C_P_8']],
                    ]
                ])
            ]);
          } elseif($data == 'search'){
...
في الاسفل هي حساباتك الوهميه المسجله في الاداة",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>'بـدء الـصـيـد⏸','callback_data'=>'run'],['text'=>'ايـقـاف الـصـيـد▶️','callback_data'=>'stop']],
                         [['text'=>'حـالـة الـحـسـابـات الـوهـمـيـة🌎','callback_data'=>'status']],
                         [['text'=>'الـمـطـور☄️','url'=>'t.me/K_8_U'],['text'=>'قـنـاتـى♻️','url'=>'t.me/C_P_8']],
                      ]
                  ])
                  ]);
          } else {
